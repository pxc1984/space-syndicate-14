...
job-description-blue-shield = Будьте персональным телохранителем глав, защищайте их от всевозможных угроз. Не выполняйте работу службы безопасности, она не должна вас обременять.
