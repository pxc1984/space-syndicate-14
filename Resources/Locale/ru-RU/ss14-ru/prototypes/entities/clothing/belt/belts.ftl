...
ent-ClothingBeltBlueShieldWebbing = армейская РПС офицера "Синий Щит"
    .desc = Ременно-плечевая система тактических ремней, которую носят элитные телохранители НаноТрейзен.
